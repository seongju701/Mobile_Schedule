...
public class DuplicateMobilePlus{
...
//그냥 생성자
  public DuplicateMobilePlus(WebDriver Driver){
		driver = Driver;
	...
	public void schedule(String Single,String Double,String SingleCon,String DoubleCon) throws InterruptedException {
        ...
        WebElement searchBtn = driver.findElement(By.xpath("//*[@id=\"js_prev_next_item_plus\"]/ul/li[1]/div"));
        Actions action = new Actions(driver);
        action.moveToElement(searchBtn).build().perform();
        Thread.sleep(3000);
        
		// 편성표 보기 버튼 클릭
		driver.findElement(By.xpath(".//*[@id=\"moduleArea\"]/div[2]/div[2]/ul/li[2]/a")).click();
